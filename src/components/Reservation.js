...
const Reservation = () => {
  ...
  return (
    <section
      id="Reservation"
      className="relative z-30 top-[340px] lg:top-[390px] h-auto pt-[60px] md:pt-[120px] mb-24"
    >
      <div className="container mx-auto">
        ...
        >
          ...
          <motion.p
            ...
            className="mb-8 text-dark text-sm md:text-xl"
          >
            {subtitle}
          </motion.p>
          {/* model */}
          ...
          >
            <img src={modelImg} alt="black separator" />
          </motion.div>
        </motion.div>
        {/* form */}
        <motion.form
        ...
        >
          ...
          <div className="max-w-[316px] mx-auto flex justify-center">
            <div className="btn capitalize w-auto lg:w-auto opacity-50 cursor-not-allowed">
              {btnText}
            </div>
          </div>
        </motion.form>
